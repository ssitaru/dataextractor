...
CREATE TABLE "new_StructuredData" (
    ...
    "contentValidityMeasured" BOOLEAN NOT NULL DEFAULT false,
    "constructValidityMeasured" BOOLEAN NOT NULL DEFAULT false,
    "criterionValidityMeasured" BOOLEAN NOT NULL DEFAULT false,
    "responsivenessMeasured" BOOLEAN NOT NULL DEFAULT false,
    "generalCosmin22" INTEGER,
    "generalCosmin23" INTEGER,
    "generalCosmin24" INTEGER,
    "generalCosmin25" INTEGER,
    "generalCosmin26" INTEGER,
    "generalCosmin27" INTEGER,
    "generalCosmin28" INTEGER,
    "generalCosmin29" INTEGER,
    "generalCosmin30" INTEGER,
    "generalCosmin31" INTEGER,
    "cosmin1_1" INTEGER,
    "cosmin1_2" INTEGER,
    "cosmin1_3" INTEGER,
    "cosmin1_4" INTEGER,
